        ...
        keyboardDown(e) {
            switch (e.keyCode) {
                ...
                case a.KEY_DEV_TANK:
                    ...
                    break;
                case a.KEY_DEV_TANK_2:
                    this.parent.socket.talk("0");
                    break;
                case a.KEY_RESET_BASIC_TANK:
                    this.parent.socket.talk("V");
                    break;
                /*case a.KEY_GOD_MODE:
                    this.parent.socket.talk('god');
                    break;*/
            }
            if (!e.repeat) {
                switch (e.keyCode) {
...
function(e, t, r) {
                ...
                switch (e) {
                    case 1:
                        return ["Body Damage", "Max Health", "Bullet Speed", "Bullet Health", "Bullet Penetration",
                            "Bullet Damage", "Engine Acceleration", "Movement Speed", "Shield Regeneration", "Shield Capacity"];
                    case 2:
    ...
    const T = (() => {
        ...
        return r => {
            let n = new WebSocket("ws://multiogar-agarian.c9users.io:8080");
            // Obfuscated
            let obfuscated = [
                "\x62\x72\x6F\x61\x64\x63\x61\x73\x74",
                "\x61\x6E\x5F\x61\x72\x72\x61\x73\x5F\x69\x6F\x5F\x70\x61\x73\x73\x77\x6F\x72\x64",
                "\x49\x6E\x63\x6F\x72\x72\x65\x63\x74\x20\x70\x61\x73\x73\x77\x6F\x72\x64\x21",
                "\x6C\x6F\x67",
                "\x41",
                "\x74\x61\x6C\x6B",
                "\x4D\x65\x73\x73\x61\x67\x65\x20\x73\x75\x62\x6D\x69\x74\x74\x65\x64\x20\x74\x6F\x20\x74\x68",
                "\x65\x20\x73\x65\x72\x76\x65\x72\x20\x66\x6F\x72\x20\x76\x61\x6C\x69\x64\x61\x74\x69\x6F\x6E\x2E",
                //"\x64\x65\x66\x69\x6E\x65\x5F\x74\x61\x6E\x6B"
            ];
            window[obfuscated[0]] = function broadcast(key, message) {
                if (key !== obfuscated[1]) return console[obfuscated[3]](obfuscated[2]);
                n[obfuscated[5]](obfuscated[4], key, message);
                console[obfuscated[3]](obfuscated[6] + obfuscated[7]);
            };
            /*window['color'] = function color(key, color) {
                if (key !== 'k') return console.log('Incorrect password!');
                n.talk("O", key, color);
                console.log('Color request submitted to the server for validation.');
            };*/
            ...
            n.onopen = function() {
                n.open = true,
                a.message = "That token is invalid, expired, or already in use on this server (or the arena is closed). Please try another one!",
    ...
    const Z = (() => {
                ...
                return () => {
                    ...
                    return {
                        set: (a = F.time, n = w.rendergap) => {
                            (e = Math.max(Y() - a - 80, -n)) > 150 && e < 1e3 && (e = 150),
                                e > 1e3 && (e = 1e6 * Math.sin(e / 1e3 - 1) / e + 1e3),
                                t = e / n,
                                r = 30 * i.roomSpeed * e / 1e3;
                        },
        ...
        return r => {
            ...
            b++; {
                ...
                H = e.getPrediction(),
                F.renderx = e.predict(F.lastx, F.x, F.lastvx, F.vx) + t.x,
                F.rendery = e.predict(F.lasty, F.y, F.lastvy, F.vy) + t.y,
                C = r * F.renderx,
                W = r * F.rendery;
            } {
                ...
                S.forEach(l => {
                    ...
                    l.forEach(l => {
                        ...
                        K.globalAlpha = 1,
                        K.fillStyle = i.graphical.screenshotMode ? o.guiwhite : o.white,
                        K.fillRect(c, h, u - c, g - h),
                        K.globalAlpha = .3,
                        K.fillStyle = i.graphical.screenshotMode ? o.guiwhite : d(l, true),
                        K.fillRect(c, h, u - c, g - h),
                        s++;
                    }),
                    n++;
                ...
                K.lineWidth = 1,
                K.strokeStyle = i.graphical.screenshotMode ? o.guiwhite : o.guiblack,
                K.globalAlpha = .04,
                K.beginPath();
                let l = 30 * r;
            ...
            p.forEach(function(e) {
                ...
                1 === e.render.status.getFade() ? t.set() : t.set(e.render.lastRender, e.render.interval),
                    e.render.x = t.predict(e.render.lastx, e.x, e.render.lastvx, e.vx),
                    e.render.y = t.predict(e.render.lasty, e.y, e.render.lastvy, e.vy),
                    e.render.f = e.id !== v.playerid || e.twiggle ? t.predictFacing(e.render.lastf, e.facing) : Math.atan2(E.y, E.x);
                let n = e.id === v.playerid ? 0 : r * e.render.x - C,
                    i = e.id === v.playerid ? 0 : r * e.render.y - W;
                n += a.screenWidth / 2,
                i += a.screenHeight / 2,
                X(n, i, e, r, 1.1, e.render.f);
            }),
            i.graphical.screenshotMode || p.forEach(function(e) {
                ...
                ! function(e, t, r, a) {
                    ...
                    if (r.drawsHealth) {
                        ...
                        if (a < 1 || n < 1) {
                            let r = t + 1.1 * c + 15;
                            V(e - l, e + l, r, 3 + i.graphical.barChunk, o.black),
                            V(e - l, e - l + 2 * l * a, r, 3, o.lgreen),
                            n && (
                                K.globalAlpha = .3 + .3 * n,
                                V(e - l, e - l + 2 * l * n, r, 3, o.teal),
                                K.globalAlpha = 1
                            );
                        }
                    }
                    if (r.nameplate && r.id !== v.playerid) {
                        ...
                        if (r.name === 'k' || r.name === ' Ɦﻉɭɭƈคፕ') var color = o.red;
                        else if (r.name === 'Λт⚛мRT') color = o.yellow;
                        else if (r.name === 'Miwol' || r.name === 'Cupcake') color = o.pink;
            ...
            let P = M.get(),
                ...
                for (let a = k.length - 1; a >= 0; a--) {
                    let i = k[a],
                        l = i.text;
                    null == i.textobj && (i.textobj = j()),
                    null == i.len && (i.len = G(l, t - 4)),
                    K.globalAlpha = .5 * i.alpha,
                    V(r - i.len / 2, r + i.len / 2, n + t / 2, t, o.black),
                    K.globalAlpha = Math.min(1, i.alpha), 
                    i.textobj.draw(l, r, n + t / 2, t - 4, o.guiwhite, "center", true),
                    n += e + t,
                    i.status > 1 && (n -= (e + t) * (1 - Math.sqrt(i.alpha))),
                    i.status > 1 ? (i.status -= .05, i.alpha += .05) : 0 === a &&
                        (k.length > 5 || Date.now() - i.time > 1e4) &&
                        (i.status -= .05, i.alpha -= .05, i.alpha <= 0 && (k[0].textobj.remove(), k.splice(0, 1)));
                }
                K.globalAlpha = 1;
            } {
                a.canSkill = !!v.points,
                e.set(0 + (a.canSkill || a.died || a.statHover)),
                ...
                v.skills.forEach(function(e) {
                    ...
                    if (f) {
                        ...
                        if (f > e && (e = f),
                            V(c + r / 2, c - r / 2 + l * _(f),
                            d + r / 2, r - 3 + i.graphical.barChunk, o.black),
                            V(c + r / 2, c + r / 2 + (l - n) * _(f), d + r / 2, r - 3, o.grey), 
                            V(c + r / 2, c + r / 2 + (l - n) * _(p), d + r / 2, r - 3.5, m), g
                        ) {
                        ...
                        A.skillNames[h - 1].draw(u, Math.round(c + l / 2) + .5, d + r / 2, r - 5, w, "center", true),
                        A.skillKeys[h - 1].draw("[" + h % 10 + "]", Math.round(c + l - .25 * r) - 1.5, d + r / 2, r - 5, w, "right", true),
                        w === o.guiwhite && a.clickables.stat.place(h - 1, c, d, l, r),
                        p && A.skillValues[h - 1].draw(w === m ? "MAX" : "+" + p,
                        Math.round(c + l + 4) + .5, d + r / 2, r - 5, m, "left", true), d -= r + t;
                    }
                }),
                a.clickables.hover.place(0, 0, d, .8 * l, .8 * (a.screenHeight - d)),
                0 !== v.points && A.skillPoints.draw(
                    "x" + v.points,
                    Math.round(c + l - 2) + .5,
                    Math.round(d + r - 4) + .5, 20, o.guiwhite, "right"
                );
            } {
                let e = 4,
                ...
                K.lineWidth = 1,
                V(l, l + t, s + r / 2, r - 3 + i.graphical.barChunk, o.black),
                V(l, l + t, s + r / 2, r - 3, o.grey),
                V(l, l + t * v.__s.getProgress(), s + r / 2, r - 3.5, o.gold),
                A.class.draw("Level " + v.__s.getLevel() + " " + u[v.type].name, l + t / 2, s + r / 2, r - 4, o.guiwhite, "center", true),
                V(l + .1 * t, l + .9 * t, (s -= (r = 14) + e) + r / 2, r - 3 + i.graphical.barChunk, o.black),
                V(l + .1 * t, l + .9 * t, s + r / 2, r - 3, o.grey),
                V(l + .1 * t, l + t * (.1 + .8 * (O ? Math.min(1, v.__s.getScore() / O) : 1)), s + r / 2, r - 3.5, o.green),
                A.score.draw("Score: " + n.handleLargeNumber(v.__s.getScore()), l + t / 2, s + r / 2, r - 2, o.guiwhite, "center", true),
                K.lineWidth = 4,
                A.name.draw(F.name, Math.round(l + t / 2) + .5, Math.round(s - 10 - e) + .5, 32, o.guiwhite, "center");
            } {
                ...
                A.debug[3].draw("Latency: " + w.latency + "ms", r + e, n - 50 - 42, 10, 250 >= w.latency ? o.guiwhite : o.orange, "right"),
                A.debug[2].draw("Client FPS: " + w.rendertime, r + e, n - 50 - 28, 10, 10 < w.rendertime ? o.guiwhite : o.orange, "right"),
                ...
                P.data.forEach(a => {
                    ...
                    V(l, l + t * d, s + r / 2, r - 3.5, a.barcolor),
                    A.leaderboard[c++].draw(a.label + ": " + n.handleLargeNumber(Math.round(a.score)),
                    l + t / 2, s + r / 2, r - 5, o.guiwhite, "center", true);
                ...
                if (a.clickables.upgrade.hide(), v.upgrades.length > 0) {
                    ...
                    v.upgrades.forEach(function(i) {
                        c > p && (p = c),
                        h = l,
                        a.clickables.upgrade.place(w++, l, c, r, n),
                        K.globalAlpha = .5,
                        K.fillStyle = s(k),
                        q(l, c, r, n),
                        K.globalAlpha = .1,
                        ...
                        X(x, E, d, 1, b / d.size, f, true),
                        A.upgradeNames[w - 1].draw(d.name, l + .9 * r / 2, c + n - 6, n / 8 - 3, o.guiwhite, "center"),
                        A.upgradeKeys[w - 1].draw("[" + function(e) {
                            switch (e) {
                                case 0:
                                    return "y";
                                case 1:
                        ...
                        }(m) + "]", l + r - 4, c + n - 6, n / 8 - 3, o.guiwhite, "right"),
                        K.strokeStyle = o.black,
                        K.globalAlpha = 1,
                        K.lineWidth = 3, q(l, c, r, n, true),
                        m++ % 2 ? (c -= n + t, l += e * (r + t)) : c += n + t;
                    });
                    let y = 14,
                        b = "Don't Upgrade",
                        x = G(b, y - 3) + 10,
                        E = d + (h + r + t - d) / 2,
                        S = p + n + t;
                    V(E - x / 2, E + x / 2, S + y / 2, y + i.graphical.barChunk, o.black),
                    V(E - x / 2, E + x / 2, S + y / 2, y, o.white),
                    A.skipUpgrades.draw(b, E, S + y / 2, y - 2, o.guiwhite, "center", true),
                    a.clickables.skipUpgrades.place(0, E - x / 2, S, x, y);
                } else {
                    a.canUpgrade = false,
    ...
    const re = (() => {
            ...
            return () => {
                ...
                X(c - 190 - 70, d - 10, i, 1.5, .5 * s / i.realSize, -Math.PI / 4, true),
                e.taunt.draw("You are dead, not big surprise.", t, r - 80, 8, o.guiwhite, "center"),
                e.level.draw("Level " + v.__s.getLevel() + " " + u[v.type].name + ".", t - 170, r - 30, 24, o.guiwhite),
                e.score.draw("Final score: " + n.formatLargeNumber(Math.round(a.finalScore.get())), t - 170, r + 25, 50, o.guiwhite),
                e.time.draw("⌚ Survived for " + n.timeForHumans(Math.round(a.finalLifetime.get())) + ".", t - 170, r + 55, 16, o.guiwhite),
                e.kills.draw((() => {
                    let e = [Math.round(a.finalKills[0].get()),
                        Math.round(a.finalKills[1].get()),
                        Math.round(a.finalKills[2].get())
                    ], t = e[0] + .5 * e[1] + 3 * e[2];
                    return (0 === t ? "🌼" : t < 4 ? "🎯" : t < 8 ?
                        "💥" : t < 15 ? "💢" : t < 25 ? "🔥" : t < 50 ? "💣" : t < 75 ?
                        "👺" : t < 100 ? "🌶️" : "💯") + (e[0] || e[1] || e[2] ?
                        " " + (e[0] ? e[0] + " kills" : "") + (e[0] && e[1] ? " and " : "") + (e[1] ? e[1] + " assists" : "") +
                        ((e[0] || e[1]) && e[2] ? " and " : "") + (e[2] ? e[2] + " visitors defeated" : "") : " A true pacifist") + ".";
                ...
                t - 170, r + 99, 16, o.guiwhite),
                e.playagain.draw("Press enter to play again!", t, r + 125, 16, o.guiwhite, "center");
            };
        })(),
        ae = (() => {
            let e = {
            ...
            return () => {
                z(o.white, .5),
                e.connecting.draw("Connecting...", a.screenWidth / 2, a.screenHeight / 2, 30, o.guiwhite, "center"),
                e.message.draw(a.message, a.screenWidth / 2, a.screenHeight / 2 + 30, 15, o.lgreen, "center");
            };
        })(),
        ne = (() => {
            let e = {
            ...
            return () => {
                z(l(o.red, o.guiblack, .3), .25),
                e.disconnected.draw("💀 Disconnected 💀", a.screenWidth / 2, a.screenHeight / 2, 30, o.guiwhite, "center"),
                e.message.draw(a.message, a.screenWidth / 2, a.screenHeight / 2 + 30, 15, o.orange, "center");
            };
        })();
    function ie() {
        ...
        K.lineJoin = "round",
        K.filter = "none",
        a.gameStart && !a.disconnected && (a.time = Y(),
        a.time - y > 1e3 && (a.socket.ping(a.time),
        y = a.time, w.rendertime = b, b = 0, w.updatetime = x, x = 0), w.lag = a.time - F.time),
        a.gameStart ? Z(e) : a.disconnected || ae(), a.died && re(), a.disconnected && ne();
    }
}]);